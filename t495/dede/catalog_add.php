...
else if($dopost=='savequick')
{
    ...
    $queryTemplate = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typenameen,typedir,isdefault,defaultname,issend,channeltype,tempindex,templist,temparticle,modname,namerule,namerule2,ispart,corank,descriptionkeywords,seotitle,moresite,siteurl,sitepath,ishidden,`cross`,`crossid`,`content`,`smalltypes`)
...
else if($dopost=='save')
{
    ...
    $in_query = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,typenameen,typedir,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('$reid','$topid','$sortrank','$typename','$typenameen','$typedir','$isdefault','$defaultname','$issend','$channeltype',
