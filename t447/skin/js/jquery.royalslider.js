	...
	$.extend($.rsProto, {
		_initVideo: function() {
			...
			self._videoDefaults = {
				...
				youTubeCode: '<iframe src="/www.youtube.com/embed/%id%?rel=1&autoplay=1&showinfo=0&autoplay=1&wmode=transparent" frameborder="no"></iframe>',
