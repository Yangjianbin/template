...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<a href='".str_replace("{page}",1,$tnamerule)."'>首</a>\r\n";
        }
        else
        {
            $indexpage="首\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末</a>\r\n";
        }
        else
        {
            $endpage="末\r\n";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<a href='".$purl."PageNo=1'>首</a>\r\n";
        }
        else
        {
            $indexpage="<a>首</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<a href='".$purl."PageNo=$totalpage'>末</a>\r\n";
        }
        else
        {
            $endpage="<a>末</a>\r\n";
